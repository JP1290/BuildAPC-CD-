...
<div class = "background">
	...
	<div class = "add_build">
		...
		<form:form action = "/addBuild" method = "post" modelAttribute = "builds">
			...
			<p>
				...
				<form:input class = "input" type = "text" path = "buildName"></form:input>
			...
			<input class = "add_build_button" type = "submit" value = "Add Your Build">
